...
static const char REF_ADDR_P2WPKH[] = "bc1qcr8te4kr609gcawutmrza0j4xv80jy8z306fyu";
...
int main(void) {
  ...
  test_scriptpubkey("P2PKH spk",       SS_SCRIPT_P2PKH,       REF_SPK_P2PKH,       sizeof(REF_SPK_P2PKH));
  test_scriptpubkey("P2SH-P2WPKH spk", SS_SCRIPT_P2SH_P2WPKH, REF_SPK_P2SH_P2WPKH, sizeof(REF_SPK_P2SH_P2WPKH));
  test_scriptpubkey("P2WPKH spk",      SS_SCRIPT_P2WPKH,      REF_SPK_P2WPKH,      sizeof(REF_SPK_P2WPKH));
  test_scriptpubkey("P2TR spk",        SS_SCRIPT_P2TR,        REF_SPK_P2TR,        sizeof(REF_SPK_P2TR));

  printf("\n--- Group 2: address derivation (account=0 chain=0 index=0) ---\n");
  test_address("P2PKH address",       SS_SCRIPT_P2PKH,       REF_ADDR_P2PKH);
  test_address("P2SH-P2WPKH address", SS_SCRIPT_P2SH_P2WPKH, REF_ADDR_P2SH_P2WPKH);
